 ...
 */
final class Version20231016142526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chat_base_messages (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', channel_id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', subject_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:ulid)\', participant_id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', title VARCHAR(100) DEFAULT NULL, body VARCHAR(4000) NOT NULL, sent_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', dtype VARCHAR(255) NOT NULL, INDEX IDX_BA8E5B172F5A1AA (channel_id), INDEX IDX_BA8E5B123EDC87 (subject_id), INDEX IDX_BA8E5B19D1C3019 (participant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE chat_message (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE chat_base_messages ADD CONSTRAINT FK_BA8E5B172F5A1AA FOREIGN KEY (channel_id) REFERENCES abstract_chat_channel (id)');
        $this->addSql('ALTER TABLE chat_base_messages ADD CONSTRAINT FK_BA8E5B123EDC87 FOREIGN KEY (subject_id) REFERENCES chat_subject (id)');
        $this->addSql('ALTER TABLE chat_base_messages ADD CONSTRAINT FK_BA8E5B19D1C3019 FOREIGN KEY (participant_id) REFERENCES abstract_chat_participant (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chat_base_messages DROP FOREIGN KEY FK_BA8E5B172F5A1AA');
        $this->addSql('ALTER TABLE chat_base_messages DROP FOREIGN KEY FK_BA8E5B123EDC87');
        $this->addSql('ALTER TABLE chat_base_messages DROP FOREIGN KEY FK_BA8E5B19D1C3019');
