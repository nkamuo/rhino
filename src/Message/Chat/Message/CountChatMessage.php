...
class CountChatMessage extends CollectionCountQuery implements ChannelAwareMessageInterface, ParticipantAwareMessageInterface, SubjectAwareMessageInterface, ActiveParticipantAwareMessageInterface{
